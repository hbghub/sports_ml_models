...
class PythonPredictor:
    ...
    def predict(self, payload):
        ...
        id = game_df.ytd_targetShareByPositionRankAdj > 0
        game_df.loc[id, 'ytd_targetShareAdj'] = game_df.ytd_targetShareByPositionRankAdj[id]
        game_df.drop(columns=['ytd_targetShareByPositionRankAdj'], inplace=True)
...
def main():
    ...
    df = load_dataset('features_target_share_test')
