...
from src.regular_time_baseline_model.utils import featureNames
...
def generate_dataset_local():
    ...
    features_train, features_test, label_train, label_test = generate_features(win_df)

    save_dataset(features_train, "features_win_prob_reg_baseline_train")

    save_dataset(features_test,  "features_win_prob_reg_baseline_test")

    save_dataset(label_train, "label_win_prob_reg_baseline_train")

    save_dataset(label_test,  "label_win_prob_reg_baseline_test")
