...
from src.regular_time_DL_model.utils import MODEL_VERSION, MODEL_DRIVE_VERSION, EXPERIMENT_NAME, MODEL_1, MODEL_2, MODEL_DRIVE,\
...
if __name__ == "__main__":
    ...
    with mlflow.start_run() as run:
    ...
    #if True:
        features_train = load_dataset('features_win_prob_reg_DL_train')[featureNames]
        label_train = load_dataset('label_win_prob_reg_DL_train').values.ravel()
        ...
        features_test = load_dataset('features_win_prob_reg_DL_test')[featureNames]
        label_test = load_dataset('label_win_prob_reg_DL_test').values.ravel()
